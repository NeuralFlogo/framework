...
class PytorchLSTM(RecurrentLayer):
    ...
    class Block(nn.Module):
        def __init__(self, input_size, hidden_size, num_layer):
            ...
            self.cell_state = self.__init_cell_state()
        ...
        def forward(self, x):
            x, (self.hidden_state, self.cell_state) = self.layer(x, (self.hidden_state, self.cell_state))
